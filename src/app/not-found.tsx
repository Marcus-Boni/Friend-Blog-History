...
import { Crown, Home, BookOpen, Scroll } from "lucide-react"
        ...
        <div className="relative z-10 w-full max-w-lg mx-auto text-center">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-sm mx-auto mb-6 sm:mb-8 px-2">
              O caminho que você procura parece ter sido consumido pela escuridão. 
              Esta página não existe ou foi movida para outro lugar no reino.
            </p>
          </motion.div>
