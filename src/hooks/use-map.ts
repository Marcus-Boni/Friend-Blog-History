...
export const mapKeys = {
  ...
  markersFiltered: (filters: { layer?: string; entityTypes?: WikiEntityType[] }) =>
 ...
 */
export function useMapMarkers(options?: { layer?: string; entityTypes?: WikiEntityType[] }) {
  return useQuery({
...
export function useUpdateEntityPosition() {
  ...
  return useMutation({
    mutationFn: ({ id, x, y, layer }: { id: string; x: number; y: number; layer?: string }) =>
